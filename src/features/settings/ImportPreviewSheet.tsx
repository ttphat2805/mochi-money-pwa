      ...
      >
        ...
        <div className="px-5 py-5 flex flex-col gap-5">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="size-16 rounded-2xl bg-accent-bg flex items-center justify-center">
              <Download size={28} className="text-accent-dark" />
            </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="h-12 w-full rounded-xl bg-accent text-white text-[14px] font-semibold disabled:opacity-40 transition-all active:scale-[0.98]"
            >
            ...
            <button
              ...
              onClick={onReplace}
              disabled={isRestoring}
              className="h-12 w-full rounded-xl border border-danger/30 text-[14px] font-medium text-danger disabled:opacity-40 transition-colors active:bg-danger-bg"
            >
