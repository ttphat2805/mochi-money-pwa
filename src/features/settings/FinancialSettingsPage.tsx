...
function PreviewRow({
  ...
  return (
    <div
      className={`flex items-center justify-between text-[13px] ${bold ? "font-semibold" : ""}`}
    >
      ...
      <div className="flex items-center gap-2 font-num">
        ...
        <span className="text-text-hint text-[11px] w-8 text-right">
          {pct}%
        </span>
      </div>
    </div>
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {extraIncomes.length > 0 ? (
          ...
          {extraIncomes.map((ei) => (
            ...
            >
              <div>
                ...
                {ei.note && (
                  <p className="text-text-muted text-[11px]">{ei.note}</p>
                )}
              </div>
              <div className="flex items-center gap-3">
                <span className="font-num text-[13px] text-text-muted">
                  +{formatVND(ei.amount)}đ
                </span>
                <button
                  type="button"
        ...
        <p className="text-text-hint text-[12px]">
          Freelance, thưởng, bán đồ...
        </p>
      )}
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Màn hình chính sẽ trở về chế độ đơn giản, không hiển thị ngân
              sách.
            </DialogDescription>
          </DialogHeader>
